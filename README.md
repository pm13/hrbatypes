...
[![Netlify Status](https://api.netlify.com/api/v1/badges/2d141e12-e877-4c09-9e80-ba12c255adb2/deploy-status)](https://app.netlify.com/projects/hrbatypes/deploys)

## Instalace

V Linuxu doporučujeme použít balíček s nástrojem **Pelican** (více viz <https://getpelican.com/>) přítomný v distribuci. Pro Ubuntu je to `pelican`, pro Fedoru `python3-pelican`. (V některých distribucích může chybět v povinných závislostech Markdown - například v Arch Linuxu je navíc potřeba balíček `python-markdown`.)
